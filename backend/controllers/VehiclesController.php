...
use backend\models\VehiclesSearch;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->validate()) {
                ...
                Yii::$app->getSession()->setFlash('success', 'Vehicles successfully added');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->validate()) {
                ...
                Yii::$app->getSession()->setFlash('success', 'Vehicles successfully updated');
                return $this->redirect(['view', 'id' => $model->id]);
            } else {
                $errors = [];
